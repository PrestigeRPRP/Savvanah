...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const audio = new Audio('/blue.mp3'); // Replace with the actual audio file path
    audio.volume = 0.5; // Set the audio volume

    // Select navigation buttons
    const prevButton = document.querySelector('.slides-nav__button--prev');
    const nextButton = document.querySelector('.slides-nav__button--next');
